...
def main():
    ...
    dataset = datasets.load_dataset("amazon_reviews_multi",'zh',split="train[:100]").map(dataset_mapping)
    ...
    for attacker in attackers:
        ...
        try:
            ...
            print(
                OpenAttack.attack_evals.ChineseAttackEval(attacker, time_clsf, progress_bar=True).eval(dataset),
