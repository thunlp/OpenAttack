...
class XlnetModel():
    def __init__(self, model_path, num_labels, max_len = 100, device="cpu"):
        import transformers
        self.tokenizer = transformers.XLNetTokenizer.from_pretrained(model_path)
        self.device = device
