...
----------------------------------------------------
​
OpenAttack provides a handy API which can easily generate adversarial examples, namely `attack_eval.generate_adv()`.
​
...
-------------------
​
We conduct adversarial training to improve the robustness of a feedforward neural network sentiment analysis model. We choose SST-2 as the dataset.
​
.. code-block:: python
    :linenos:
    import OpenAttack
...
​
Run ``python examples/adversarial_training.py`` to see visualized results.